...
where possible, the setup for TPC installation will begin. After the TPC is completely installed in cryostat 1, its purge and cool-down can begin. %These processes are described in Section ?. 
...
\includegraphics[width=\textwidth]{fd-install-startup-sequence}
\end{cdrfigure}
