...
\fixme{Carlos: I have difficulty finding most of the numbers
  representing the expected performance of the photon detection
  system. Therefore the majority of my fixme's are related to this
  central question: where can we find the benchmarking for the PD?} 
