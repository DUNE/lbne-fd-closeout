...
\fixme{In our 2012 CDR we started each chapter with:  The scope of the
  (whichever) subsystem includes the design, procurement, fabrication,
  testing, delivery and installation of the mechanical and high
  voltage components of the (blah); followed by list of components --
  see the TPC chapter. At this late date, not sure it's worth it...} 
...
shows the probability of (?)\fixme{} MeV energy deposition being
