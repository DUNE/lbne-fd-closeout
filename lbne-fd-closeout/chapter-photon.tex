...
The reference design for mounting the PDs into the APA frames calls for
...
The reference design assumes that three SiPM signals \fixme{outputs?} can be ganged
...
In the reference design, the front-end electronics reside outside of the
...
In the reference design of the PD electronics, %the approach was taken to have 
