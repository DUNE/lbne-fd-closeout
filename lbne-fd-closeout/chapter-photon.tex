...
\begin{cdrfigure}[Probability of photon being detected in
  detectors when depositing energy]{photon_map}{Photon map giving the number of photons expected per MeV deposited energy accounting for the efficiencies listed in table~\ref{example}}
  \includegraphics[width=0.4\textwidth]{projX50_phperMeV.png}
  \includegraphics[width=0.4\textwidth]{projZ35_phperMeV.png}
\end{cdrfigure}
...
\begin{cdrfigure}[Schematic drawing of a light guide with its
    ...
    \includegraphics[width=.85\columnwidth]{WaveguideSketch.eps}
\end{cdrfigure}
